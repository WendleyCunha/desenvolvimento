...
def _conteudo_pedido(enc: dict, cancelado: bool):
    ...
    medidas da cliente e formulário de edição. É o mesmo "miolo" usado tanto
    dentro de um popup (Encomendas/Agenda) quanto dentro do painel de
    detalhe do BLOCO CONTRATOS — a única diferença é o container que o
    envolve por fora.
    """
